    ...
    <Card className="mb-4">
      ...
      <View className="flex-row justify-between">
        <View className="items-center flex-1">
          ...
          <Typography variant="caption" className="text-gray-500 text-center">Pending</Typography>
        </View>
        ...
        <View className="items-center flex-1">
          ...
          <Typography variant="caption" className="text-gray-500 text-center">Completed</Typography>
        </View>
        ...
        <View className="items-center flex-1">
          ...
          <Typography variant="caption" className="text-gray-500 text-center">Overdue</Typography>
        </View>
      </View>
    </Card>
  );
